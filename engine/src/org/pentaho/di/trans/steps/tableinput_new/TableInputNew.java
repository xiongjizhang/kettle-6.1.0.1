 ...
 * @since 8-apr-2003
 */
public class TableInputNew extends BaseStep implements StepInterface {
  private static Class<?> PKG = TableInputNewMeta.class; // for i18n purposes, needed by Translator2!!

  private TableInputNewMeta meta;
  private TableInputNewData data;

  public TableInputNew( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
    Trans trans ) {
  ...
  public void stopRunning( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    meta = (TableInputNewMeta) smi;
    data = (TableInputNewData) sdi;
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    if ( super.init( smi, sdi ) ) {
      ...
      if (meta.getDatabaseMeta() == null) {
    	  meta.setDatabaseMeta( DatabaseMeta.findDatabase(meta.getDatabaseMetas(), 
    			  environmentSubstitute( meta.getDatabaseName() )) );
      }
