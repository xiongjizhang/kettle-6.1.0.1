 ...
 *
 */
public class TableInputNewMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
    TableInputNewMeta retval = (TableInputNewMeta) super.clone();
    return retval;
  }
  ...
  public String getXML() {
    ...
    retval.append( "    " + XMLHandler.addTagValue( "database_name", databaseName ) );
    StreamInterface infoStream = getStepIOMeta().getInfoStreams().get( 0 );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new TableInputNew( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new TableInputNewData();
  }
  ...
  @Override
  public TableInputNewMetaInjection getStepMetaInjectionInterface() {
    return new TableInputNewMetaInjection( this );
  }
