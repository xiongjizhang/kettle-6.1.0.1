 ...
 * @author Chris
 */
public class TableInputNewMetaInjection implements StepMetaInjectionInterface {
  ...
  public TableInputNewMetaInjection( TableInputNewMeta meta ) {
    this.meta = meta;
  }
  ...
  public List<StepInjectionMetaEntry> getStepInjectionMetadataEntries() throws KettleException {
    ...
    Entry[] topEntries =
      new Entry[] {
        Entry.SQL, Entry.DATABASE_META, Entry.LAZY_CONVERSION, Entry.REPLACE_VARIABLES, Entry.EXECUTE_FOR_EACH_ROW, Entry.LIMIT, };
  ...
  public TableInputNewMeta getMeta() {
    return meta;
  }
}
